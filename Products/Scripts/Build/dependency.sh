...
AgoraWidgets_URL="${Artifactory_iOS_URL}/AgoraWidgets/feature_2.8.103_im_group/dev/AgoraWidgets_2.8.103.zip"

AgoraEduCore_URL="${Artifactory_iOS_URL}/AgoraEduCore/release_2.8.104/dev/AgoraEduCore_2.8.104.zip"
